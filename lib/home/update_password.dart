...
class UpdatePasswordPage extends StatelessWidget {
  ...
  UpdatePasswordPage(this.userModel, this.userRepository);
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  maxLines: 2,
                  onSaved: (val) {
                    if (title.contains("Old Password")) {
                      _oldPass = val;
                    } else if (title.contains("New Password")) {
                      _newPass = val;
                    }
                  },
        ...
        child: Scaffold(
          ...
          body: BlocListener<HomeBloc, HomeState>(
            listener: (context, state) {
              if (state is UpdatePassRequestedLoaded) {
                ...
                Scaffold.of(context).showSnackBar(
                  SnackBar(
                    content: Text("Updation of Password Failed, Please check if Old Password is correct"),
            ...
            child: BlocBuilder<HomeBloc, HomeState>(
              builder: (context, state) {
                ...
                else if (state is UpdatePassLoaded) {
                  return WillPopScope(
                    onWillPop: () {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Form(
                            ...
                            child: ListView(
                              children: [
                                buildInputs("Old Password"),
                                buildInputs("New Password"),
                                SizedBox(
                                  height: 10,
                                ),
                                Align(
