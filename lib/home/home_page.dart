      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            title: new Text("Note !!"),
            content: new Text(
                "You can Change/Update your Password from the Hamburger Menu in the Top Left Corner"),
            actions: <Widget>[
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.of(context).push(new MaterialPageRoute(
                              builder: (_) =>
                                  ContactUsPage(userModel, userRepository)));
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          Navigator.of(context).push(new MaterialPageRoute(
                              builder: (_) =>
                                  ReportProbPage(userModel, userRepository)));
                        },
                      ),
                    ),
                    SizedBox(
        ...
        body: BlocListener<HomeBloc, HomeState>(
          listener: (context, state) {
            if (state is HomeError) {
              ...
              Scaffold.of(context).showSnackBar(
                SnackBar(
                  content: Text('Your Purchase for Item ' +
                      state.purchasedItem.goodiesName.toUpperCase() +
                      ' is Successful'),
                  backgroundColor: Colors.red,
                ),
              );
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.of(context).push(new MaterialPageRoute(
                                  builder: (_) =>
                                      PracticePage(userModel, userRepository)));
                            },
                            child: Container(
                                margin: EdgeInsets.fromLTRB(
                                    MediaQuery.of(context).size.width * 0.1,
                              ...
                              return Center(
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Image.network(
                                        state.shoppingItemsList[index].image,
                                        height:
                                            MediaQuery.of(context).size.height *
                                                0.3,
                                        width:
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Center(
                                              child: Text(
                                            state.shoppingItemsList[index].name,
                                            style: TextStyle(
                                                color: Color(0xFF0f3a3f),
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18,
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                BlocProvider.of<HomeBloc>(
                                                        context)
                                                    .add(ItemConfirmationEvent(
                                                        state.shoppingItemsList[
                                                            index],
                                                        userModel));
                                              },
                                              child: Container(
